...
var orderSchema = new mongoose.Schema({
    //1、订单基本信息
    orderCode: {type: String, length: 16, index: { unique: true }},//生成订单号(16位)终端2位,设备号2位,时间6位,序号6位
    ...
    dealPlatform: {type: String, default:'onSite'},//交易平台，区分线上线下和移动端(onSite,ios,android)
    ...
    //4、支付信息
    payInfo: {
        PrePayType: {type: Number},
        //支付方式：
        // 0 支付宝 1 银联  2 VISA信用卡 3 代付 4 分期 5自提,6.paypal,7webchat,8iPayLink,9 零元支付,10 paydollar,11 payeco
        ...
        buyTime: {type: Date, default: new Date()},//购买者下单时间
    ...
    //7、订单数据信息
    createdOn: {type: Date, default: new Date()},//订单创建时间
